    ...
    return <div className="filter-section drop-down-section expanded">
        ...
        <div className="range-setting drop-down-content">
            <span className="range-input">
                <input type="text" id="price-from" name="PriceFrom" defaultValue={from} onKeyDown={unfocusOnEnter} />
            </span>
            <span className="range-dash">&ndash;</span>
            <span className="range-input">
                <input type="text" id="price-to" name="PriceTo" defaultValue={to} onKeyDown={unfocusOnEnter} />$
            </span>
        </div>
    </div>;
}
