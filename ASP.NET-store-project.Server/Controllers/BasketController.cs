...
namespace ASP.NET_store_project.Server.Controllers
{
    ...
    public class BasketController(AppDbContext context) : ControllerBase
    {
        ...
        //    var basket = customer
        //        .SelectMany(customer => customer.OrderedProducts)
        ...
        //    context.Orders.Add(new PendingOrder(customer.Single().Id, Guid.NewGuid(), "????", 10, 0) { Id = orderId }); // SUPPLIER MOCKUP <<<<!!!!!!!!!!!!!!!!
        //    context.SaveChanges();
        ...
        //            new SelectedProduct(newlySelectedItemId, itemId, customer.Single().Id, 1));
        //    }
