...
{
    // Class for uniform way of sending multiple async requests to multiple external APIs
    // Implements methods meant for GET and POST requests
    // The methods are mostly the same, some contain default values and call the base function
